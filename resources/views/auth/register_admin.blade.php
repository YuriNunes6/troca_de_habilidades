...
@section('content')
<x-auth-card>
    <h2 class="text-xl font-bold mb-4 text-center">Cadastro de Administrador</h2>
    ...
    <form method="POST" action="{{ route('register.admin') }}">
        ...
        <button type="submit"
            class="w-full bg-red-600 text-white py-2 rounded hover:bg-red-700">Cadastrar Admin</button>
    </form>
